...
namespace libtest {
struct runtime_mod_comb
{
    static constexpr const char* path       = "runtime_mod_comb";
    static constexpr const char* name       = "Modular combinatorial operations (Runtime MOD)";
    ...
    static void generate_output(std::ifstream& input_file, std::ofstream& output_file)
    {
        ...
        const auto [n, mod, q] = sc.read_vals<usize, ull, usize>();
    ...
    static bool judge(std::ifstream& input_file, std::ifstream& generated_output_file, std::ifstream& solution_output_file)
    {
        ...
        const auto [n, mod, q] = in_sc.read_vals<usize, ull, usize>();
        for (usize i = 0; i < q; i++) {
